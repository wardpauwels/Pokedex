...
public class AddButtonListener implements ActionListener {
	...
	public AddButtonListener(PokeFrameController pokeFrameController, PokeFrame pokeFrame) {
	...
	public void actionPerformed(ActionEvent e) {
		Pokemon pokemon = (Pokemon) pokeFrame.getNewPokemonChooseComboBox().getItemAt(pokeFrame.getNewPokemonChooseComboBox().getSelectedIndex());
